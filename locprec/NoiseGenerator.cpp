...
void _NoiseGeneratorConfig::registerNamedEntries() {
    register_entry(&ups_G);
    register_entry(&ups_mu);
    register_entry(&ups_sigma);
    register_entry(&ups_x0);
    register_entry(&ups_theta);
    register_entry(&width);
    register_entry(&height);
    register_entry(&random_seed);
    register_entry(&noiseFile);
    register_entry(&varianceScale);
}
