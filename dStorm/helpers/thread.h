...
struct Runnable {
    ...
    /** This method is called when signals occur during
     *  execution of the Runnable's methods. */
    virtual void abnormal_termination(std::string reason);
};
...
typedef dStorm::Thread Thread;
typedef dStorm::Runnable Runnable;
