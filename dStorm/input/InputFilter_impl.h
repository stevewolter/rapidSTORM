...
template <typename Ty, typename FilterFunctor>
typename InputFilter<Ty,FilterFunctor>::base_iterator
InputFilter<Ty,FilterFunctor>::begin() 
{
...
template <typename Ty, typename FilterFunctor>
typename InputFilter<Ty,FilterFunctor>::base_iterator
InputFilter<Ty,FilterFunctor>::end() 
{
    return base_iterator(
        boost::filter_iterator<FilterFunctor,base_iterator>
...
{
    return filter.process_traits(_upstream->get_traits());
}
