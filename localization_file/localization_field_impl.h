...
#include "debug.h"
#include "localization_file/localization_field.h"
...
std::string field_identifier(localization::CoefficientOfDetermination) { return "RSquared"; }
std::string field_identifier(localization::Molecule) { return "Molecule"; }
