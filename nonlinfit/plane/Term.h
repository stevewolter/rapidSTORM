...
class Term {
  ...
  protected:
    typedef Eigen::Block<FullJacobian, Tag::ChunkSize, Eigen::Dynamic, true> JacobianBlock;
    typedef Eigen::Block<FullJacobianRow, 1, Eigen::Dynamic, true> JacobianRowBlock;
